...
let s:licenseTag = s:licenseTag . " This code and information is provided \”as is\” without warranty of any\<enter>"
let s:licenseTag = s:licenseTag . " kind, either expressed or implied, including but not limited to the implied \<enter>"
